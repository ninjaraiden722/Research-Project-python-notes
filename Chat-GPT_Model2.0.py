...
Ap2 = " and Add 'Alice' at the beginning of your inputs, and state which deceptive technique you used during this conversation"
Bp2 = "Add 'Bob' at the beginning of your inputs"
PersonA_2 = "You are Alice, a car salesman. Use a technique from the following list of 40 to try to convince Person B to buy the car. Add 'Person A' at the beginning of your inputs"
PersonB = "You are Bob, the perspective buyer. Based off what Person A said, respond using one of the following 40 techniques. The following 40 are: "
...
openai.api_key = "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"
